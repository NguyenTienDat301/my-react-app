...
// import type { score, ScoreField } from '../types/interface';
...
//   const [editRowData, setEditRowData] = useState<score | null>(null);
...
//   const handleStartEdit = (item: score) => {
...
//   const handleEditInputChange = (field: keyof score, value: string) => {
...
//                       {(
//                         ['quanSo', 'hocTap', 'tacPhong', 'kyLuat', 'noiVu', 'tangGia', 'vkTrangBi'] as (keyof score)[]
//                       ).map((field) => (
